...
\end{center}
The work handed in should be entirely your own. You can consult the textbook and/or the class notes but nothing else. To receive full credit, justify your answer in a clear and logical way. Due Nov.~4.

\paragraph{Reading.} Read Sections 3.1, 3.3, 3.4 of the textbook carefully.

\begin{enumerate}
\item Section 3.1 Exercise 1, 3, 6.
