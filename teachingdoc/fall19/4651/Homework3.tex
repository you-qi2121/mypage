...
\end{center}
The work handed in should be entirely your own. You can consult the textbook and/or the class notes but nothing else. To receive full credit, justify your answer in a clear and logical way. Due Sept.~18.

\paragraph{Reading.} Read Sections 1.6, 2.1 of the textbook carefully. The proof of maximal chains of linearly independent subsets is the subject of Section 1.7, which is another proof for the existence of bases. This section is optional material, but it is recommended you read it through.
